...
import { getProducts, seedProducts, createProduct, updateProduct, deleteProduct } from "../controllers/product.controller.js";
...
gorrasRouter.post("/crear", verificarToken, verificarRol(["admin", "super-admin"]), createProduct);
